                ...
                <div className = "user-form">
                    ...
                    <form>
                        ...
                        <label className = "user-details-form-label">
                            Phone Number
                            <br/>
                            <input className = "user-details-form-input" type= "number" required placeholder="Phone" pattern="[0-9]{10}"></input>
                        </label> 
                        <br/>
                        <label className = "user-details-form-label">
                            Address
                        ...
                        <label className = "user-details-form-label">
                            Country
                            <br/>
                            <input  className = "user-details-form-input" type= "text" required placeholder= "Country"></input>
                        </label>
                        <br/>
